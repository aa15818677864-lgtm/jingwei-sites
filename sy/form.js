document.addEventListener('DOMContentLoaded', function () {
    ...
    contactForm.addEventListener('submit', async function (event) {
        ...
        try {
            const clientIp = await Promise.race([loadClientIp(), new Promise(resolve => setTimeout(() => resolve(''), 1200))]);
