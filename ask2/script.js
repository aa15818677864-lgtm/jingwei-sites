(function () {
  ...
  const SESSION_BASE_KEY = "jingwei.ask2.chat.session.v1";
  const BACKUP_BASE_KEY = "jingwei.ask2.chat.backup.v1";
  const ARCHIVE_BASE_KEY = "jingwei.ask2.chat.archive.v1";
  const SESSION_KEY = "jingwei.ask2.chat.session.v1" + storageSuffix;
  const BACKUP_KEY = "jingwei.ask2.chat.backup.v1" + storageSuffix;
  const ARCHIVE_KEY = "jingwei.ask2.chat.archive.v1" + storageSuffix;
