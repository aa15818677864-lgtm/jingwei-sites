document.addEventListener('DOMContentLoaded', function () {
    ...
    const phoneRules = {
        '+1': {
            pattern: /^[0-9]{10}$/,
            message_zh: '\u8acb\u8f38\u516510\u4f4d\u6578\u5b57\uff08\u5982\uff1a2125550123\uff09',
            message_en: 'Please enter 10 digits (e.g., 2125550123)',
            alert_zh: '\u7f8e\u570b\u96fb\u8a71\u865f\u78bc\u5fc5\u9808\u662f10\u4f4d\u6578\u5b57',
            alert_en: 'U.S. phone number must be 10 digits',
            placeholder_zh: '\u8acb\u8f38\u516510\u4f4d\u6578\u5b57',
